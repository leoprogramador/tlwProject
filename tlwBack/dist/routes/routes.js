...
router.post('/user/edit', passport_1.privateRoute, exports.upload.single("image"), UserValidator_1.UserValidator.editUser, UserController.editActions);
...
router.post('/ad/add', passport_1.privateRoute, exports.upload.array("images", 5), AdsController.addAction);
router.get('/ad/list', AdsController.getList);
router.get('/ad/item', AdsController.getItem);
router.post('/ad/:id', passport_1.privateRoute, exports.upload.array("images", 5), AdsController.editAction);
